...
const PageUI = lazy(() => import("../Pages/pageUI"));
const ComponentUI = lazy(() => import("../Pages/componentUI"));
// const Cart = lazy(() => import("../Layouts/Cart.layout"));

const routes = [
  { path: "/test/page/", exact: false, Component: PageUI, title: "page test", isPrivate: true },
  { path: "/test/component/", exact: false, Component: ComponentUI, title: "Dashboard", isPrivate: true },
