   ...
   return (
      <div className={"pb-24"} style={{ direction: "ltr" }}>
         <nav className={"flex justify-between items-center p-4"}>
            ...
            {/* ------------------------------- Fixed Links ------------------------------ */}
            <div className={"fixed z-10 inset-x-4 bottom-4 bg-gray-700 rounded-2xl flex justify-between items-center p-4 text-2xl"}>
               <button className={"w-12 h-12 rounded-xl bg-white text-gray-700"}><i className={"bi bi-house-door"} /></button>
               <button className={"w-12 h-12 rounded-xl text-gray-300"}><i className={"bi bi-search"} /></button>
               <button className={"w-12 h-12 rounded-xl text-gray-300"}><i className={"bi bi-bag-dash"} /></button>
               <button className={"w-12 h-12 rounded-xl text-gray-300"}><i className={"bi bi-person"} /></button>
            </div>
         </nav>
         <main className={"p-4"}>
            <h1 className={"text-4xl mt-10 font-serif"}>
               ...
               <br />
               <span className={"font-medium"}>match <span className={"border-b-4 border-red-400"}>style!</span></span>
            </h1>
               ...
               <div className={"list flex overflow-x-auto p-4 -mx-4"}>
                  <div className={"flex gap-4"}>
                     ...
                     <div className={"relative p-3 pb-5 shadow-md rounded-3xl overflow-hidden"} >
                        ...
                        <button className={"py-2 px-5 leading-none bg-gray-700 text-gray-50 absolute bottom-0 right-0 rounded-tl-3xl"}>Add</button>
                     </div>
                     <div className={"relative p-3 pb-5 shadow-md rounded-3xl overflow-hidden"} >
                        <div className={"relative w-60 h-60 rounded-2xl overflow-hidden"}>
                           <img className={"w-full h-full object-cover object-center"} src={car} alt="car" />
